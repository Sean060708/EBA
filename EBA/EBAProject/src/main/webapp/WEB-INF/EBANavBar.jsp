...
<nav class="navbar navbar-expand-lg navbar-light bg-white fixed-top shadow d-flex flex-column">
		<div class="container-fluid justify-content-end">
			...
			<a href="#" class="me-2 text-decoration-none">
				<i class="fas fa-shopping-cart fa-lg me-2" style="color: #428bca"></i>
				<strong class="p-secondary me-2">購物車 ( ${shopCount ? shopCount : '0'} )</strong>
			</a>
